...
<template>
    <ActionSection>
        ...
        <template #content>
            <h3 v-if="twoFactorEnabled && ! confirming" class="text-lg font-semibold text-ink dark:text-white">
                You have enabled two factor authentication.
            </h3>

            <h3 v-else-if="twoFactorEnabled && confirming" class="text-lg font-semibold text-ink dark:text-white">
                Finish enabling two factor authentication.
            </h3>

            <h3 v-else class="text-lg font-semibold text-ink dark:text-white">
                You have not enabled two factor authentication.
            </h3>

            <div class="mt-3 max-w-xl text-sm text-slate-600 dark:text-zinc-300">
                <p>
            ...
            <div v-if="twoFactorEnabled">
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-slate-600 dark:text-zinc-300">
