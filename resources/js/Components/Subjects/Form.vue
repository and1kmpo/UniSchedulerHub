        ...
        <FormSection @submitted="$emit('submit')">
            ...
            <template #form>
                <div class="col-span-6 sm:col-span-6">
                    ...
                    <TextInput for="name" v-model="form.name" type="text" autocomplete="name" class="mt-1 block w-full"
                        placeholder="Enter a subject name" />

                    <InputLabel for="description" value="Description" />
                    <TextInput for="description" v-model="form.description" type="text" autocomplete="description"
                        class="mt-1 block w-full" placeholder="Enter program description" />

                    <InputLabel for="credits" value="Credits" />
                    <TextInput for="credits" v-model="form.credits" type="number" autocomplete="credits"
                    ...
                    <TextInput for="knowledge_area" v-model="form.knowledge_area" type="text"
