...
<template>
    <div>
        <div v-if="show && message" :class="{ 'bg-success': style == 'success', 'bg-danger': style == 'danger' }">
            <div class="max-w-screen-xl mx-auto py-2 px-3 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between flex-wrap">
                    <div class="w-0 flex-1 flex items-center min-w-0">
                        <span class="flex rounded-lg p-2" :class="{ 'bg-emerald-700/25': style == 'success', 'bg-red-800/25': style == 'danger' }">
                    ...
                    <div class="shrink-0 sm:ms-3">
                        <button
                            ...
                            :class="{ 'hover:bg-emerald-700/25 focus:bg-emerald-700/25': style == 'success', 'hover:bg-red-800/25 focus:bg-red-800/25': style == 'danger' }"
                            aria-label="Dismiss"
