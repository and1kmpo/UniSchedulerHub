    ...
    <FormSection @submitted="$emit('submit')">
        ...
        <template #form>
            <div class="col-span-6 sm:col-span-6 space-y-2">
                <InputLabel for="first_name" value="Student" />
                <TextInput
                    for="first_name"
                ...
                <TextInput
                    ...
                    placeholder="Enter the student's first last name"
                />
                <InputError
                ...
                <TextInput
                    ...
                    class="mt-1 block w-full"
                    placeholder="Enter the student's document number"
                />
                <InputError
                    :message="$page.props.errors.document"
                    class="mt-2"
                />
                ...
                <InputError
                    :message="$page.props.errors.semester"
                    class="mt-2"
                />
                ...
                >
                    ...
                    <option
                        v-for="(programName, programId) in $props.programs"
                        :key="programId"
                        :value="programId"
                    >
                        {{ programName }}
                ...
                <InputError
                    :message="$page.props.errors.program_id"
                    class="mt-2"
                />
            </div>
        </template>
